#
# time.mk - DevOpsBroker makefile for compiling the org.devopsbroker.time package
#
...
SRC_DIR := $(BASEDIR)/src/org/devopsbroker/time
OBJ_DIR := $(BASEDIR)/obj/org/devopsbroker/time
